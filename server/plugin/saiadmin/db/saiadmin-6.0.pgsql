...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_attachment" CASCADE;
...
CREATE INDEX "idx_sa_system_attachment_hash" ON "sa_system_attachment" ("hash");
CREATE INDEX "idx_sa_system_attachment_idx_url" ON "sa_system_attachment" ("url");
CREATE INDEX "idx_sa_system_attachment_idx_create_time" ON "sa_system_attachment" ("create_time");
CREATE INDEX "idx_sa_system_attachment_idx_category_id" ON "sa_system_attachment" ("category_id");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_category" CASCADE;
...
CREATE INDEX "idx_sa_system_category_pid" ON "sa_system_category" ("parent_id");
CREATE INDEX "idx_sa_system_category_sort" ON "sa_system_category" ("sort");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_config" CASCADE;
...
CREATE INDEX "idx_sa_system_config_group_id" ON "sa_system_config" ("group_id");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_config_group" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_dept" CASCADE;
...
CREATE INDEX "idx_sa_system_dept_idx_parent_id" ON "sa_system_dept" ("parent_id");
CREATE INDEX "idx_sa_system_dept_idx_path" ON "sa_system_dept" ("level");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_dict_data" CASCADE;
...
CREATE INDEX "idx_sa_system_dict_data_type_id" ON "sa_system_dict_data" ("type_id");
CREATE INDEX "idx_sa_system_dict_data_idx_code" ON "sa_system_dict_data" ("code");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_dict_type" CASCADE;
...
CREATE INDEX "idx_sa_system_dict_type_idx_code" ON "sa_system_dict_type" ("code");
CREATE INDEX "idx_sa_system_dict_type_idx_name" ON "sa_system_dict_type" ("name");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_login_log" CASCADE;
...
CREATE INDEX "idx_sa_system_login_log_username" ON "sa_system_login_log" ("username");
CREATE INDEX "idx_sa_system_login_log_idx_create_time" ON "sa_system_login_log" ("create_time");
CREATE INDEX "idx_sa_system_login_log_idx_login_time" ON "sa_system_login_log" ("login_time");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_mail" CASCADE;
...
CREATE INDEX "idx_sa_system_mail_idx_create_time" ON "sa_system_mail" ("create_time");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_menu" CASCADE;
...
CREATE INDEX "idx_sa_system_menu_idx_parent_id" ON "sa_system_menu" ("parent_id");
CREATE INDEX "idx_sa_system_menu_idx_slug" ON "sa_system_menu" ("slug");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_oper_log" CASCADE;
...
CREATE INDEX "idx_sa_system_oper_log_username" ON "sa_system_oper_log" ("username");
CREATE INDEX "idx_sa_system_oper_log_idx_create_time" ON "sa_system_oper_log" ("create_time");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_post" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_role" CASCADE;
...
CREATE UNIQUE INDEX "idx_sa_system_role_uk_slug" ON "sa_system_role" ("code");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_role_dept" CASCADE;
...
CREATE INDEX "idx_sa_system_role_dept_idx_role_id" ON "sa_system_role_dept" ("role_id");
CREATE INDEX "idx_sa_system_role_dept_idx_dept_id" ON "sa_system_role_dept" ("dept_id");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_role_menu" CASCADE;
...
CREATE INDEX "idx_sa_system_role_menu_idx_menu_id" ON "sa_system_role_menu" ("menu_id");
CREATE INDEX "idx_sa_system_role_menu_idx_role_id" ON "sa_system_role_menu" ("role_id");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_user" CASCADE;
...
CREATE UNIQUE INDEX "idx_sa_system_user_uk_username" ON "sa_system_user" ("username");
CREATE INDEX "idx_sa_system_user_idx_dept_id" ON "sa_system_user" ("dept_id");

-- ----------------------------
-- Records of sa_system_user
-- ----------------------------
INSERT INTO "sa_system_user" VALUES (1, 'admin', '$2y$10$wnixh48uDnaW/6D9EygDd.OHJK0vQY/4nHaTjMKBCVDBP2NiTatqS', '祭道之上', '2', NULL, 'saiadmin@admin.com', '15888888888', 'SaiAdmin是兼具设计美学与高效开发的后台系统!', 'statistics', 1, 1, 1, NULL, NULL, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
INSERT INTO "sa_system_user" VALUES (2, 'martin', '$2y$10$J3EkwRH8rNkveaanx1.j.ebRiBpnnVUGWa.i2MS3aNpb9ydAOolmm', '刘炽平', '2', NULL, 'martin@163.com', '15888888888', NULL, 'work', 1, 0, 1, '', NULL, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
INSERT INTO "sa_system_user" VALUES (3, 'allen', '$2y$10$H8d7riOjOiwPSopguEQ1fuKZz.fA0A54OvuzTqgJlbG1N3uOxEwM.', '张小龙', '', NULL, '', '15888888888', NULL, 'work', 10, 0, 1, '', NULL, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
INSERT INTO "sa_system_user" VALUES (4, 'mark', '$2y$10$sY/4StKVV.N/8Ock8J8kdeIOK4jS4tAUoYjkzvB8Tzy0fLh.wA2KS', '任宇昕', NULL, NULL, NULL, '15888888888', NULL, 'work', 11, 0, 1, NULL, NULL, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
INSERT INTO "sa_system_user" VALUES (5, 'dowson', '$2y$10$sY/4StKVV.N/8Ock8J8kdeIOK4jS4tAUoYjkzvB8Tzy0fLh.wA2KS', '汤道生', NULL, NULL, NULL, '15888888888', NULL, 'work', 12, 0, 1, NULL, NULL, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
INSERT INTO "sa_system_user" VALUES (10, 'timi_boss', '$2y$10$sY/4StKVV.N/8Ock8J8kdeIOK4jS4tAUoYjkzvB8Tzy0fLh.wA2KS', '姚晓光', NULL, NULL, '', '15888888888', NULL, 'work', 111, 0, 1, '', NULL, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
INSERT INTO "sa_system_user" VALUES (100, 'dev_wang', '$2y$10$sY/4StKVV.N/8Ock8J8kdeIOK4jS4tAUoYjkzvB8Tzy0fLh.wA2KS', '王程序员', NULL, NULL, NULL, '15888888888', NULL, 'work', 1111, 0, 1, NULL, NULL, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
INSERT INTO "sa_system_user" VALUES (101, 'dev_li', '$2y$10$sY/4StKVV.N/8Ock8J8kdeIOK4jS4tAUoYjkzvB8Tzy0fLh.wA2KS', '李策划', NULL, NULL, NULL, '15888888888', NULL, 'work', 1111, 0, 1, NULL, NULL, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);

-- ----------------------------
-- Table structure for sa_system_user_post
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_user_post" CASCADE;
...
CREATE INDEX "idx_sa_system_user_post_idx_user_id" ON "sa_system_user_post" ("user_id");
CREATE INDEX "idx_sa_system_user_post_idx_post_id" ON "sa_system_user_post" ("post_id");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_system_user_role" CASCADE;
...
CREATE INDEX "idx_sa_system_user_role_idx_role_id" ON "sa_system_user_role" ("role_id");
CREATE INDEX "idx_sa_system_user_role_idx_user_id" ON "sa_system_user_role" ("user_id");
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_tool_crontab" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_tool_crontab_log" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_tool_generate_columns" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "sa_tool_generate_tables" CASCADE;
CREATE TABLE "sa_tool_generate_tables" (
  ...
  "generate_path" varchar(100) NULL DEFAULT 'saiadmin-artd',
...
SELECT setval(pg_get_serial_sequence('public.sa_system_attachment', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_attachment"), 1), EXISTS (SELECT 1 FROM "sa_system_attachment"));
SELECT setval(pg_get_serial_sequence('public.sa_system_category', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_category"), 1), EXISTS (SELECT 1 FROM "sa_system_category"));
SELECT setval(pg_get_serial_sequence('public.sa_system_config', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_config"), 1), EXISTS (SELECT 1 FROM "sa_system_config"));
SELECT setval(pg_get_serial_sequence('public.sa_system_config_group', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_config_group"), 1), EXISTS (SELECT 1 FROM "sa_system_config_group"));
SELECT setval(pg_get_serial_sequence('public.sa_system_dept', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_dept"), 1), EXISTS (SELECT 1 FROM "sa_system_dept"));
SELECT setval(pg_get_serial_sequence('public.sa_system_dict_data', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_dict_data"), 1), EXISTS (SELECT 1 FROM "sa_system_dict_data"));
SELECT setval(pg_get_serial_sequence('public.sa_system_dict_type', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_dict_type"), 1), EXISTS (SELECT 1 FROM "sa_system_dict_type"));
SELECT setval(pg_get_serial_sequence('public.sa_system_login_log', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_login_log"), 1), EXISTS (SELECT 1 FROM "sa_system_login_log"));
SELECT setval(pg_get_serial_sequence('public.sa_system_mail', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_mail"), 1), EXISTS (SELECT 1 FROM "sa_system_mail"));
SELECT setval(pg_get_serial_sequence('public.sa_system_menu', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_menu"), 1), EXISTS (SELECT 1 FROM "sa_system_menu"));
SELECT setval(pg_get_serial_sequence('public.sa_system_oper_log', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_oper_log"), 1), EXISTS (SELECT 1 FROM "sa_system_oper_log"));
SELECT setval(pg_get_serial_sequence('public.sa_system_post', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_post"), 1), EXISTS (SELECT 1 FROM "sa_system_post"));
SELECT setval(pg_get_serial_sequence('public.sa_system_role', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_role"), 1), EXISTS (SELECT 1 FROM "sa_system_role"));
SELECT setval(pg_get_serial_sequence('public.sa_system_role_dept', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_role_dept"), 1), EXISTS (SELECT 1 FROM "sa_system_role_dept"));
SELECT setval(pg_get_serial_sequence('public.sa_system_role_menu', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_role_menu"), 1), EXISTS (SELECT 1 FROM "sa_system_role_menu"));
SELECT setval(pg_get_serial_sequence('public.sa_system_user', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_user"), 1), EXISTS (SELECT 1 FROM "sa_system_user"));
SELECT setval(pg_get_serial_sequence('public.sa_system_user_post', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_user_post"), 1), EXISTS (SELECT 1 FROM "sa_system_user_post"));
SELECT setval(pg_get_serial_sequence('public.sa_system_user_role', 'id'), COALESCE((SELECT MAX("id") FROM "sa_system_user_role"), 1), EXISTS (SELECT 1 FROM "sa_system_user_role"));
SELECT setval(pg_get_serial_sequence('public.sa_tool_crontab', 'id'), COALESCE((SELECT MAX("id") FROM "sa_tool_crontab"), 1), EXISTS (SELECT 1 FROM "sa_tool_crontab"));
SELECT setval(pg_get_serial_sequence('public.sa_tool_crontab_log', 'id'), COALESCE((SELECT MAX("id") FROM "sa_tool_crontab_log"), 1), EXISTS (SELECT 1 FROM "sa_tool_crontab_log"));
SELECT setval(pg_get_serial_sequence('public.sa_tool_generate_columns', 'id'), COALESCE((SELECT MAX("id") FROM "sa_tool_generate_columns"), 1), EXISTS (SELECT 1 FROM "sa_tool_generate_columns"));
SELECT setval(pg_get_serial_sequence('public.sa_tool_generate_tables', 'id'), COALESCE((SELECT MAX("id") FROM "sa_tool_generate_tables"), 1), EXISTS (SELECT 1 FROM "sa_tool_generate_tables"));
