...
class InstallLogic
{
    ...
    public function dependConflictHandle(): bool
    {
        ...
        $webDep = new Depends(dirname(base_path()) . DIRECTORY_SEPARATOR . env('FRONTEND_DIR', 'sandadmin-vue') . DIRECTORY_SEPARATOR . 'package.json');
        ...
        if ($depends) {
            foreach ($depends as $key => $item) {
                ...
                if ($key == 'dependencies' || $key == 'devDependencies') {
                    $coverFiles[] = dirname(base_path()) . DIRECTORY_SEPARATOR . env('FRONTEND_DIR', 'sandadmin-vue') . DIRECTORY_SEPARATOR . 'package.json';
                }
            }
        }
