...
// +----------------------------------------------------------------------
namespace plugin\sandadmin\app\controller\system;

use plugin\sandadmin\service\Permission;
use plugin\sandadmin\basic\BaseController;
use plugin\sandadmin\utils\ServerMonitor;
...
class SystemServerController extends BaseController
{
    ...
    {
        $menu_cache = config('plugin.sandadmin.saithink.menu_cache', []);
        $button_cache = config('plugin.sandadmin.saithink.button_cache', []);
        $config_cache = config('plugin.sandadmin.saithink.config_cache', []);
        $dict_cache = config('plugin.sandadmin.saithink.dict_cache', []);
        $reflection_cache = config('plugin.sandadmin.saithink.reflection_cache', []);
