...
// +----------------------------------------------------------------------
namespace plugin\sandadmin\utils\code;
...
class CodeZip
{
    ...
    {
        return [
            'template_path' => base_path().DIRECTORY_SEPARATOR.'plugin'.DIRECTORY_SEPARATOR.'sandadmin'.DIRECTORY_SEPARATOR.'utils'.DIRECTORY_SEPARATOR.'code'.DIRECTORY_SEPARATOR.'stub',
            'generate_path' => runtime_path().DIRECTORY_SEPARATOR.'code_engine'.DIRECTORY_SEPARATOR.'sandadmin',
        ];
    }
