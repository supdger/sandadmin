...
class CodeEngine
{
    ...
    {
        return [
            'template_path' => base_path() . DS . 'plugin' . DS . 'sandadmin' . DS . 'utils' . DS . 'code' . DS . 'stub',
            'generate_path' => runtime_path() . DS . 'code_engine' . DS . 'sandadmin',
        ];
    }
