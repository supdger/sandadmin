...
<script setup lang="ts">
  ...
  import SaiRadio from '@/components/sand/sa-radio/index.vue'
   ...
   * 表单数据
   */
  const formData = reactive<DictDataForm>({ ...initialFormData })
   ...
   * 初始化表单数据
   */
  const initForm = (data: Partial<DictDataForm>) => {
