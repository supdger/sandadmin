...
def make_preview(images: dict[int, Image.Image]) -> Image.Image:
    ...
    draw.text((60, 24), "Prominent volumetric particle S - light", fill="#142235", font=title_font)
    draw.text((860, 24), "Prominent volumetric particle S - dark", fill="#142235", font=title_font)
