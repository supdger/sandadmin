...
def make_preview(images: dict[int, Image.Image]) -> Image.Image:
    ...
    draw.text((60, 24), "Fuller organic particle S - light", fill="#142235", font=title_font)
    draw.text((860, 24), "Fuller organic particle S - dark", fill="#142235", font=title_font)
