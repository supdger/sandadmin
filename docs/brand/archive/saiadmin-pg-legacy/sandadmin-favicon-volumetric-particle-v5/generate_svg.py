...
def main() -> None:
  ...
  <circle cx="382" cy="96" r="15" fill="#71F0E7" opacity="0.42" filter="url(#particleGlow)"/>
  <circle cx="126" cy="422" r="16" fill="#FFD269" opacity="0.46" filter="url(#particleGlow)"/>
