...
def make_preview(images: dict[int, Image.Image]) -> Image.Image:
    ...
    draw.text((60, 24), "No dark outline - light background", fill="#142235", font=title_font)
    draw.text((860, 24), "No dark outline - dark background", fill="#142235", font=title_font)
